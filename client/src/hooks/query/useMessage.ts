...
//   function useGetAllUnseenMessages(userId: string) {
//     return useQuery({
//       queryKey: [QueryKeys.GET_ALL_UNSEEN_MESSAGES],
//       queryFn: () => customAxiosRequestForGet("/messages/unseen", { userId }),
//     });
//   }
